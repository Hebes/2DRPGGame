...
namespace Core
{
    public class CroeUIManager : ICore
    {
        public static CroeUIManager Instance;
        ...
        {
            GameObject gameObjectTemp = CoreLoadResManager.Instance.Load<GameObject>("UIPanel/Global/UI");
        ...
        public void CloseUIForms(string uiFormName)
        {
            ...
            CoreMonoManager.Instance.UpdateRemoveEvent(baseUiForm.UIUpdate);
        ...
        private T LoadUIPanel<T>(string uiFormName) where T : UIBase, new()
        {
            ...
            //创建的UI克隆体预设
            GameObject uiPanel = CoreLoadResManager.Instance.Load<GameObject>(uiFormName);

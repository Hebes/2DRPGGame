...
namespace Core
{
    public class CroeUIManager : ICore
    {
        ...
        {
            //GameObject gameObjectTemp = CoreLoadResManager.Instance.Load<GameObject>("go");
        ...
        public void CloseUIForms(string uiFormName)
        {
            ...
            CoreMonoManager.Instance.OnRemoveUpdateEvent(baseUiForm.UIUpdate);
        ...
        private T LoadUIPanel<T>(string uiFormName) where T : UIBase, new()
        {
            ...
            t.UIName = uiFormName;
            t.UIAwake();
            CoreMonoManager.Instance.OnAddUpdateEvent(t.UIUpdate);

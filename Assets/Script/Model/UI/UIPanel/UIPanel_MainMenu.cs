...
namespace RPGGame
{
    public class UIPanel_MainMenu : UIBase
    {
        public override void UIAwake()
        {
            ...
            GameObject T_Newgame = UIComponent.Get<GameObject>("T_Newgame");
            GameObject T_Exitgame = UIComponent.Get<GameObject>("T_Exitgame");
            ...
            if (ModelSave.Instance.HasSavedData() == false)
        ...
        {
            ModelSave.Instance.DeleteSavedData();
            LoadSceneWithFadeEffect(1.5f).Forget();
        }

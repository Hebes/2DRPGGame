...
namespace RPGGame
{
    public class ModelUIManager : IModelInit, ISaveManager
    {

        public static ModelUIManager Instance;
        ...
        {
            Instance = this;
            CoreMonoManager.Instance.UpdateAddEvent(OnUpdate);
            await UniTask.Yield();
        }
        ...
        {
            ConfigEvent.EventPlayAudioSource.EventTriggerUniTask(ConfigAudio.mp3sfx_click, EAudioSourceType.SFX, false).Forget();

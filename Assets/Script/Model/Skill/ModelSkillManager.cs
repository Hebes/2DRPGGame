...
namespace RPGGame
{
    public class ModelSkillManager : IModelInit, ISaveManager
    {
        public static ModelSkillManager Instance;
        ...
        public async UniTask Init()
        {
            ...
            {
                CoreMonoManager.Instance.AwakeAddEvent(item.Awake);
                CoreMonoManager.Instance.UpdateAddEvent(item.Update);

...
namespace RPGGame
{
    public class UIPanel_InGame : UIBase
    {
        ...
        //属性
        private ModelSkillManager skills => ModelSkillManager.Instance;
        ...
        {
            if (soulsAmount < ModelDataManager.Instance.currency)
                soulsAmount += Time.deltaTime * increaseRate;
            else
                soulsAmount = ModelDataManager.Instance.currency;

...
namespace RPGGame
{
    public class UIPanel_Character : UIBase
    {
        ...
        public override void UIAwake()
        {
            ...
            GameObject T_Inventory = UIComponent.Get<GameObject>("T_Inventory");
            GameObject T_Equipment = UIComponent.Get<GameObject>("T_Equipment");
            GameObject T_Stats = UIComponent.Get<GameObject>("T_Stats");

            inventory = T_Inventory.transform;
            equipment = T_Equipment.transform;
            stats = T_Stats.transform;
